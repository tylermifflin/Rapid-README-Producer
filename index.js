...
// used inquirer to prompt the user with the questions array, used input to store the answers to the name section, used list for the license question to give the user a list of licenses to choose from 
inquirer
    .prompt([
        {
            type: 'input',
    ...
    // function to write the readme file, used the generateMarkdown function to create the readme const, used fs to write the readme const to a file called README.md
    .then((response) => {
